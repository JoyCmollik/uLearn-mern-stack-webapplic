				...
				<div className='grid grid-cols-12 gap-6'>
					...
					<div className='col-span-8 p-8'>
						...
						<div className='flex'>
							...
							<div className='border flex flex-col space-y-5 p-6 w-full'>
						...
						>
							<button className='text-sm text-dark border font-medium py-2 px-3 '>
								{!show ? (
									<span>
						...
						<div className='py-8 pl-14'>
							<span className=''>
								...
								demonstrates many important aspects of what
								Python code looks like and how it works. Let's
								review the code from top to bottom.
							</span>
						</div>
						{/*------------------code 2----------------------*/}
